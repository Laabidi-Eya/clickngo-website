...
<script>
  const giftBtn = document.getElementById('fixed-gift-button');

  giftBtn.addEventListener('mouseenter', () => {
    showMessage("Une surprise t’attend dans ta ClickBox ! 🎁 Clique vite !");
  });

  giftBtn.addEventListener('mouseleave', hideMessage);

  giftBtn.addEventListener('click', (e) => {
    e.preventDefault();
    showMessage("Chargement de ta ClickBox magique... ✨");
    setTimeout(() => {
      window.location.href = giftBtn.getAttribute('href');
    }, 1200);
  });
</script>
